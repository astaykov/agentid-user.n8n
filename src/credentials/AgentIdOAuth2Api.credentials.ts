...
export class AgentIdOAuth2Api implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		{
			displayName: 'Agent User (upn of the Agent User to impersonate)',
			name: 'agentUser',
			type: 'string',
			default: '',
			required: true,
			description: 'UPN (User Principal Name) of the Agent User to impersonate. This is used in the Digital Worker / Digital Employee scenario.',
		},
		{
			displayName: 'Scope',
			name: 'scope',
